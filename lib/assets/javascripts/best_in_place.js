...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.send_method       = self.send_method       || $parent.attr("data-method");
      self.send_name         = self.send_name         || $parent.attr("data-name");
      self.send_ref_date     = self.send_ref_date     || $parent.attr("data-refdate");
    });
    ...
    self.send_method       = self.element.attr("data-method")              || self.send_method;
    self.send_name         = self.element.attr("data-name")                || self.send_name;
    self.send_ref_date     = self.element.attr("data-refdate")             || self.send_ref_date;
  ...
  requestData : function() {
    ...
    if( this.element.attr("data-method") == 'post' ) 
      { data = "_method=post"; 
        additional_params = 'monthly_stat[name]='+
                            this.send_name+
                            "&monthly_stat[ref_date]="+
                            this.send_ref_date+"&"+
                            "monthly_stat[service]="+"&";
      }
    else
      { data = "_method=put"; }

    data += "&" + additional_params + this.objectName + '[' + this.attributeName + ']=' + encodeURIComponent(this.getValue());
  ...
  ajax : function(options) {
    options.url = this.element.attr("data-url");/*this.url;*/
  ...
  loadSuccessCallback : function(data) {
    var hola = jQuery.parseJSON(data)
    ...
    if(data && data!=""){
      ...
      this.element.trigger(jQuery.Event("best_in_place:success"), hola);
      this.element.trigger(jQuery.Event("ajax:success"), hola);
    } else {
